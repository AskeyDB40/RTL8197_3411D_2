...
M_EXTERN_DRIVER( VOIP_MGR_SET_MULTI_RING_CADENCE );
...
M_EXTERN_DRIVER( VOIP_MGR_SET_PROSLIC_PARAM_STEP1 ); 
M_EXTERN_DRIVER( VOIP_MGR_SET_PROSLIC_PARAM_STEP2 ); 
M_EXTERN_DRIVER( VOIP_MGR_SLIC_NEON_LAMP );
...
M_EXTERN_DRIVER( VOIP_MGR_SET_DAA_HYBRID );
M_EXTERN_DRIVER( VOIP_MGR_SET_FXO_TUNE );
...
M_EXTERN_DRIVER( VOIP_MGR_QOS_CFG );
