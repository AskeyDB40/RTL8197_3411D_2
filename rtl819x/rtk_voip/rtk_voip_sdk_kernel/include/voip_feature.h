...
#define PLATFORM_8881A			SHL32( 0x60000000 )	//8881A Soc
...
#define PLATFORM_TYPE_89xxE		SHL32( 0x18000000 )	//89xxE
#define PLATFORM_TYPE_8881A		SHL32( 0x10000000 )	//8881A
...
/* VoIP DMEM SIZE (bit 52-54)*/
#define VOIP_DMEM_SIZE_MASK	SHL32( 0x00700000 )
#define VOIP_DMEM_SIZE_0K	SHL32( 0x00000000 )
#define VOIP_DMEM_SIZE_4K	SHL32( 0x00100000 )
#define VOIP_DMEM_SIZE_8K	SHL32( 0x00200000 )
#define VOIP_DMEM_SIZE_16K	SHL32( 0x00300000 )
#define VOIP_DMEM_SIZE_32K	SHL32( 0x00400000 )
#define VOIP_DMEM_SIZE_64K	SHL32( 0x00500000 )
#define VOIP_DMEM_SIZE_128K	SHL32( 0x00600000 )
#define VOIP_DMEM_SIZE_256K	SHL32( 0x00700000 )
#define VOIP_DMEM_SIZE_SHIFT	52

/* VoIP IMEM SIZE (bit 49-51)*/
#define VOIP_IMEM_SIZE_MASK	SHL32( 0x000E0000 )
#define VOIP_IMEM_SIZE_0K	SHL32( 0x00000000 )
#define VOIP_IMEM_SIZE_4K	SHL32( 0x00020000 )
#define VOIP_IMEM_SIZE_8K	SHL32( 0x00040000 )
#define VOIP_IMEM_SIZE_16K	SHL32( 0x00060000 )
#define VOIP_IMEM_SIZE_32K	SHL32( 0x00080000 )
#define VOIP_IMEM_SIZE_64K	SHL32( 0x000A0000 )
#define VOIP_IMEM_SIZE_128K	SHL32( 0x000C0000 )
#define VOIP_IMEM_SIZE_256K	SHL32( 0x000E0000 )
#define VOIP_IMEM_SIZE_SHIFT	49

/* Reserved bits 48 for misc */
...
#define CODEC_AMR_WB_SUPPORT		SHL32( 0x00000400 )
#define CODEC_AMR_WB_NOT_SUPPORT	~CODEC_AMR_WB_SUPPORT
...
#define RTK_VOIP_PLATFORM_CHK_IS8881A(f)	((uint32)(((f) & RTK_VOIP_PLATFORM_MASK)>>32) == (uint32)((PLATFORM_8881A | PLATFORM_TYPE_8881A)>>32))
#define RTK_VOIP_PLATFORM_CHK_IS89xxE(f)	((uint32)(((f) & RTK_VOIP_PLATFORM_MASK)>>32) == (uint32)((PLATFORM_89xx | PLATFORM_TYPE_89xxE)>>32))
#else
...
#define RTK_VOIP_PLATFORM_CHK_IS8881A(f)	(((f) & RTK_VOIP_PLATFORM_MASK) == (PLATFORM_8881A | PLATFORM_TYPE_8881A))
#define ROIP_PLATFORM_CHK_IS89xxE(f)	(((f) & RTK_VOIP_PLATFORM_MASK) == (PLATFORM_89xx | PLATFORM_TYPE_89xxE))
#endif
...
#define RTK_VOIP_IMEM_SIZE(f)		( unsigned int )(1<<((((f)& VOIP_IMEM_SIZE_MASK) >> VOIP_IMEM_SIZE_SHIFT)-1))*(0x1000)
#define RTK_VOIP_DMEM_SIZE(f)		( unsigned int )(1<<((((f)& VOIP_DMEM_SIZE_MASK) >> VOIP_DMEM_SIZE_SHIFT)-1))*(0x1000)
