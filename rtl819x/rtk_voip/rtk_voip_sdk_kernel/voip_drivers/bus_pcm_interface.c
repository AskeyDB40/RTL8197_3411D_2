...
#include "../../voip_dsp/dsp_r1/common/util/codec_mem.h"
	...
	!defined(CONFIG_RTK_VOIP_PLATFORM_8686) &&	!defined(CONFIG_RTK_VOIP_DRIVERS_PCM89xxE) && !defined(CONFIG_RTK_VOIP_DRIVERS_PCM8881A)
...
// proc 
// --------------------------------------------------------
#if  defined(CONFIG_LINUX_KERNEL_3_10)
static int voip_pcm_regs_read_proc(struct seq_file *f, void *v)
{
	int n = 0;
	
	seq_printf( f, "PCMCR= 0x%08x\n", pcm_inl(PCMCR));
	seq_printf( f, "PCMCHCNR= 0x%08x\n", pcm_inl(PCMCHCNR));
	seq_printf( f, "PCMBSIZE= 0x%08x\n", pcm_inl(PCMBSIZE));
	seq_printf( f, "CH0TXBSA= 0x%08x\n", pcm_inl(CH0TXBSA));
	seq_printf( f, "CH0RXBSA= 0x%08x\n", pcm_inl(CH0RXBSA));
	seq_printf( f, "CH1TXBSA= 0x%08x\n", pcm_inl(CH1TXBSA));
	seq_printf( f, "CH1RXBSA= 0x%08x\n", pcm_inl(CH1RXBSA));
	seq_printf( f, "CH2TXBSA= 0x%08x\n", pcm_inl(CH2TXBSA));
	seq_printf( f, "CH2RXBSA= 0x%08x\n", pcm_inl(CH2RXBSA));
	seq_printf( f, "PCMTSR= 0x%08x\n", pcm_inl(PCMTSR));
	seq_printf( f, "PCMIMR= 0x%08x (order:%d)\n", pcm_inl(PCMIMR), SUPPRESSION_PCM_INT_ORDER);
	seq_printf( f, "PCMISR= 0x%08x\n", pcm_inl(PCMISR));	
	seq_printf( f, "PCMCHCNR47= 0x%08x\n", pcm_inl(PCMCHCNR47));
	seq_printf( f, "PCMBSIZE47= 0x%08x\n", pcm_inl(PCMBSIZE47));
	seq_printf( f, "CH4TXBSA= 0x%08x\n", pcm_inl(CH4TXBSA));
	seq_printf( f, "CH4RXBSA= 0x%08x\n", pcm_inl(CH4RXBSA));
	seq_printf( f, "CH5TXBSA= 0x%08x\n", pcm_inl(CH5TXBSA));
	seq_printf( f, "CH5RXBSA= 0x%08x\n", pcm_inl(CH5RXBSA));
	seq_printf( f, "CH6TXBSA= 0x%08x\n", pcm_inl(CH6TXBSA));
	seq_printf( f, "CH6RXBSA= 0x%08x\n", pcm_inl(CH6RXBSA));
	seq_printf( f, "PCMTSR47= 0x%08x\n", pcm_inl(PCMTSR47));
	seq_printf( f, "PCMIMR47= 0x%08x (order:%d)\n", pcm_inl(PCMIMR47), SUPPRESSION_PCM_INT_ORDER);
	seq_printf( f, "PCMISR47= 0x%08x\n", pcm_inl(PCMISR47));	
#if PCM_VERSION == 0x0400
	seq_printf( f, "PCMCHCNR811= 0x%08x\n", pcm_inl(PCMCHCNR811));	
	seq_printf( f, "PCMTSR811= 0x%08x\n", pcm_inl(PCMTSR811));	
	seq_printf( f, "PCMBSIZE811= 0x%08x\n", pcm_inl(PCMBSIZE811));	
	seq_printf( f, "CH8TXBSA= 0x%08x\n", pcm_inl(CH8TXBSA));	
	seq_printf( f, "CH8RXBSA= 0x%08x\n", pcm_inl(CH8RXBSA));	
	seq_printf( f, "CH9TXBSA= 0x%08x\n", pcm_inl(CH9TXBSA));	
	seq_printf( f, "CH9RXBSA= 0x%08x\n", pcm_inl(CH9RXBSA));	
	seq_printf( f, "CH10TXBSA= 0x%08x\n", pcm_inl(CH10TXBSA));	
	seq_printf( f, "CH10RXBSA= 0x%08x\n", pcm_inl(CH10RXBSA));	
	seq_printf( f, "CH11TXBSA= 0x%08x\n", pcm_inl(CH11TXBSA));	
	seq_printf( f, "CH11RXBSA= 0x%08x\n", pcm_inl(CH11RXBSA));	
	seq_printf( f, "PCMIMR811= 0x%08x\n", pcm_inl(PCMIMR811));	
	seq_printf( f, "PCMISR811= 0x%08x\n", pcm_inl(PCMISR811));	
	
	seq_printf( f, "PCMCHCNR1215= 0x%08x\n", pcm_inl(PCMCHCNR1215));	
	seq_printf( f, "PCMTSR1215= 0x%08x\n", pcm_inl(PCMTSR1215));	
	seq_printf( f, "PCMBSIZE1215= 0x%08x\n", pcm_inl(PCMBSIZE1215));	
	seq_printf( f, "CH12TXBSA= 0x%08x\n", pcm_inl(CH12TXBSA));	
	seq_printf( f, "CH12RXBSA= 0x%08x\n", pcm_inl(CH12RXBSA));	
	seq_printf( f, "CH13TXBSA= 0x%08x\n", pcm_inl(CH13TXBSA));	
	seq_printf( f, "CH13RXBSA= 0x%08x\n", pcm_inl(CH13RXBSA));	
	seq_printf( f, "CH14TXBSA= 0x%08x\n", pcm_inl(CH14TXBSA));	
	seq_printf( f, "CH14RXBSA= 0x%08x\n", pcm_inl(CH14RXBSA));	
	seq_printf( f, "CH15TXBSA= 0x%08x\n", pcm_inl(CH15TXBSA));	
	seq_printf( f, "CH15RXBSA= 0x%08x\n", pcm_inl(CH15RXBSA));	
	seq_printf( f, "PCMIMR1215= 0x%08x\n", pcm_inl(PCMIMR1215));	
	seq_printf( f, "PCMISR1215= 0x%08x\n", pcm_inl(PCMISR1215));	

	seq_printf( f, "PCMINTMAP= 0x%08x\n", pcm_inl(PCMINTMAP));	
	seq_printf( f, "PCMWTSR03= 0x%08x\n", pcm_inl(PCMWTSR03));	
	seq_printf( f, "PCMWTSR47= 0x%08x\n", pcm_inl(PCMWTSR47));	
	seq_printf( f, "PCMBUFOWCHK= 0x%08x\n", pcm_inl(PCMBUFOWCHK));	
#endif // PCM_VERSION == 0x0400


	seq_printf( f, "\n" );
	seq_printf( f, "wideband_hybrid_bits=%08X\n", bus_pcm_wideband_hybrid_bits );
...
#ifdef PCM_DBG_PROC
#if  defined(CONFIG_LINUX_KERNEL_3_10)
static int voip_pcm_dbg_read_proc(struct seq_file *f, void *v)
{
	int n = 0;

	int i;
	
	seq_printf( f, "CH		T[] 	 R[]	 TE[]	  RF[]	   T_[] 	R_[]\n" );
	seq_printf( f, "-- -------- -------- -------- -------- -------- --------\n" );
	
	for( i = 0; i < BUS_PCM_CH_NUM; i ++ ) {
		seq_printf( f, "%2d %8X %8X %8X %8X %8X %8X\n",
...
#if  defined(CONFIG_LINUX_KERNEL_3_10)
static int voip_pcm_read_proc(struct seq_file *f, void *v)
{
	int ch;//, ss;
	int n = 0;

	if( IS_CH_PROC_DATA( (long)f->private ) ) {
		ch = CH_FROM_PROC_DATA( (long)f->private );
		seq_printf( f, "channel=%d\n", ch );
		seq_printf( f, "enable: %s\n", ( chanEnabled[ ch ] ?
												"yes" : "no" ) );
	} else {
...
{
	return single_open(file, voip_pcm_regs_read_proc, NULL);
}
...
//read:   voip_pcm_regs_read_proc
};

static int dbg_open(struct inode *inode, struct file *file)
{
	return single_open(file, voip_pcm_dbg_read_proc, NULL);
}
...
struct file_operations proc_dbg_fops = {
	...
	.llseek	= seq_lseek,
	.release = single_release,	
//read:   voip_pcm_dbg_read_proc
};

static int pcm_open(struct inode *inode, struct file *file)
{
	return single_open(file, voip_pcm_read_proc, PDE_DATA(file_inode(file)));
}

struct file_operations proc_pcm_fops = {
	.owner	= THIS_MODULE,
	.open	= pcm_open,
	.read	= seq_read,
	.llseek	= seq_lseek,
	.release = single_release,	
//read:   voip_pcm_read_proc
};
#endif
...
{
#if  defined(CONFIG_LINUX_KERNEL_3_10)
	proc_create_data(PROC_VOIP_DIR "/" PROC_VOIP_PCM_DIR "/regs", 0, NULL, &proc_regs_fops, NULL );

#ifdef PCM_DBG_PROC
	proc_create_data(PROC_VOIP_DIR "/" PROC_VOIP_PCM_DIR "/dbg", 0, NULL, &proc_dbg_fops, NULL );
#endif

	create_voip_channel_proc_read_entry( "pcm", &proc_pcm_fops );
#else
