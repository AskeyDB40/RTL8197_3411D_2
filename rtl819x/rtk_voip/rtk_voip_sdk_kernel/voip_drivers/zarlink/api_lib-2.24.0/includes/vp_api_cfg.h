...
#ifdef REALTEK_PATCH_FOR_MICROSEMI
#ifdef VP_DEBUG
#define VP_OPTION_DEFAULT_DEBUG_SELECT \
					         (	VP_DBG_ERROR | 			\
								VP_DBG_INFO			|	\
								VP_DBG_WARNING		|	\
								VP_DBG_HOOK			|	\
								...
								VP_DBG_LINE_STATE)
#else
#define VP_OPTION_DEFAULT_DEBUG_SELECT (VP_DBG_ERROR | VP_DBG_WARNING | VP_DBG_INFO)
#endif
#endif
/******************************************************************************
...
#define VP890_INCLUDE_TESTLINE_CODE     
#endif
#endif
...
#ifdef REALTEK_PATCH_FOR_MICROSEMI
#if defined(CONFIG_RTK_VOIP_DRIVERS_SLIC_LINETEST)										 
#define VP886_INCLUDE_TESTLINE_CODE 			
#endif	
#endif
...
#ifdef REALTEK_PATCH_FOR_MICROSEMI
#define	VP886_SIMPLE_POLLED_MODE
#endif
...
#ifdef REALTEK_PATCH_FOR_MICROSEMI
#define VP886_EVENT_QUEUE_SIZE 18
#else
