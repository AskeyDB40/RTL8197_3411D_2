...
static struct GpioShare GpioShare_setting[][2] =
{
	...
	{{0,0},{0,0}},	/* Port D6 */
	{{0,0},{0,0}},	/* Port D7 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port E0 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port E1 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port E2 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port E3 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port E4 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port E5 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port E6 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port E7 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port F0 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port F1 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port F2 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port F3 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port F4 */
	{{SET_BIT(7)|SET_BIT(8)|SET_BIT(9)|SET_BIT(10)|SET_BIT(11), SET_BIT(7)|SET_BIT(8)|SET_BIT(10)|SET_BIT(11)}, {0,0}},	/* Port F5 */
	{{SET_BIT(2)|SET_BIT(3)|SET_BIT(4), SET_BIT(2)|SET_BIT(3)}, {0,0}},	/* Port F6 */
	{{0,0},{0,0}},	/* Port F7 */
...
static inline uint32 _getGpio( enum GPIO_FUNC func, enum GPIO_PORT port, uint32 pin )
{
	...
	GPIO_PRINT(5, "[%s():%d] func=%d port=%d pin=%d\n", __FUNCTION__, __LINE__, func, port, pin );
	switch( func )
	{
...
static inline void _setGpio( enum GPIO_FUNC func, enum GPIO_PORT port, uint32 pin, uint32 data )
{
	...
	GPIO_PRINT(5, "[%s():%d] func=%d port=%d pin=%d data=%d\n", __FUNCTION__, __LINE__, func, port, pin, data );
	switch( func )
	{
		case GPIO_FUNC_DEDICATE:
			GPIO_PRINT(4, "[%s():%d] regGpioControl[port]=0x%08x  bitStartGpioControl[port]=%d\n", __FUNCTION__, __LINE__, regGpioControl[port], bitStartGpioControl[port] );
...
/*
@func int32 | _rtl8881A_initGpioPin | Initiate a specifed GPIO port.
...
/*
@func int32 | _rtl8881A_getGpioDataBit | Get the bit value of a specified GPIO ID.
...
int32 _rtl8881A_getGpioDataBit( uint32 gpioId, uint32* pData )
{
	...
	*pData = _getGpio( GPIO_FUNC_DATA, port, pin );
	GPIO_PRINT(5, "[%s():%d] (port=%d,pin=%d)=%d\n", __FUNCTION__, __LINE__, port, pin, *pData );
	return SUCCESS;
}

/*
@func int32 | _rtl8881A_setGpioDataBit | Set the bit value of a specified GPIO ID.
@parm uint32 | gpioId | GPIO ID
...
/*
@func uint32 | _init_GpioShare_setting | init rtl 8881A revision GPIO registers
@rvalue int | val | 0:success; otherwise fail
@comm
init rtl 8881A GPIO registers in GpioShare_setting table
default value is used for rtl 8881A revision B 
*/
