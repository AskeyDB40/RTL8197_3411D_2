...
**
** $Id: si3226_intf.h 4461 2014-07-16 15:39:20Z nizajerk $
**
** Si3226_Intf.h
...
void Si3226_Set_Ring_Cadence_ON(proslicChanType *pProslic, unsigned short msec, unsigned char timer_enable);
void Si3226_Set_Ring_Cadence_OFF(proslicChanType *pProslic, unsigned short msec, unsigned char timer_enable);
