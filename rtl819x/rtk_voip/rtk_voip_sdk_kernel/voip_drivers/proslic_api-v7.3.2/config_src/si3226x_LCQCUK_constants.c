...
0x050AF108L,	/* VBATR_EXPECT (78.793 v) */
...
0x80,			/* RINGCON */
0x00,			/* USERSTAT */
0x02857884L,	/* VCM_RING (36.396 v) */
0x02857884L,	/* VCM_RING_FIXED */
