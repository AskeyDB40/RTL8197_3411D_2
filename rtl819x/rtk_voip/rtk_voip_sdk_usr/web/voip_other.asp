...
<body bgcolor="#EEEEEE" text="#000000" onload="InitOther()">
...
<table cellSpacing=1 cellPadding=2 border=0 width=450 >
<tr>
   	<td bgColor=#aaddff width=150>SIP Prack</td>
	<td bgColor=#ddeeff>
		<input type=checkbox name=sip_disable_prack <%voip_other_get("sip_disable_prack");%>>Disabled
	</td>
</tr>
<tr>
   	<td bgColor=#aaddff width=150>SIP Server Rendundacy</td>
	<td bgColor=#ddeeff>
		<input type=checkbox name=sip_enable_redundancy <%voip_other_get("sip_enable_redundancy");%>>Enabled
	</td>
</tr>
<tr>
   	<td bgColor=#aaddff width=150>SIP CLIR anonymouse from header</td>
	<td bgColor=#ddeeff>
		<input type=checkbox name=sip_anonymouse_from <%voip_other_get("sip_anonymouse_from");%>>Enabled
	</td>
</tr>
<tr>
   	<td bgColor=#aaddff width=150>Non-SIP INBOX call</td>
	<td bgColor=#ddeeff>
		<input type=checkbox name=sip_internalcall <%voip_other_get("sip_internalcall");%>>Enabled
	</td>
</tr>
<tr>
   	<td bgColor=#aaddff width=150>Hook Flash Relay setting</td>
			<td bgColor=#ddeeff>
...
<table cellSpacing=1 cellPadding=2 border=0 width=450>
	...
	<tr>
   	<td bgColor=#aaddff width=150>Options interval time</td>
	<td bgColor=#ddeeff>
