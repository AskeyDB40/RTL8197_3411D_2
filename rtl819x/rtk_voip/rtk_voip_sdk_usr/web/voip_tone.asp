...
<body bgcolor="#EEEEEE" text="#000000" onload="InitToneConfig()">

<form method="post" action="/goform/voip_tone_set" name=toneform>
<b>Select Country</b>
...
<table cellSpacing=1 cellPadding=2 border=0 width=400>
	...
	<tr>
		<td bgColor=#ddeeff><font size=1>0 cycle is continuous</font>
		</td>	
	</tr>
	...
	<tr>
    	...
    	<td bgColor=#ddeeff>
		<input type=text name=cadNUM size=10 maxlength=2 value=<%voip_tone_get("cadNUM");%>> <font size=1>(1~4 for ADDITIVE, MODULATED, SUCC, SUCC_ADD; 1~32 for FOUR_FREQ; 2 for STEP_INC, TWO_STEP )</font></td>
	</tr>

   <tr>
		<td  bgColor=#aaddff>CadOn0</td>
    	<td bgColor=#ddeeff><input type=text name=CadOn0 size=20 maxlength=9 value="<%voip_tone_get("CadOn0");%>"> <font size=1>(msec)</font></td>
	</tr>
	
   <tr>
		<td  bgColor=#aaddff>CadOff0</td>
    	<td bgColor=#ddeeff><input type=text name=CadOff0 size=20 maxlength=9 value="<%voip_tone_get("CadOff0");%>"> <font size=1>(msec)</font></td>
	</tr>
	
   <tr>
		<td  bgColor=#aaddff>CadOn1</td>
    	<td bgColor=#ddeeff><input type=text name=CadOn1 size=20 maxlength=9 value="<%voip_tone_get("CadOn1");%>"> <font size=1>(msec)</font></td>
	</tr>
   <tr>
		<td  bgColor=#aaddff>CadOff1</td>
    	<td bgColor=#ddeeff><input type=text name=CadOff1 size=20 maxlength=9 value="<%voip_tone_get("CadOff1");%>"> <font size=1>(msec)</font></td>
	</tr>
   <tr>
		<td  bgColor=#aaddff>CadOn2</td>
    	<td bgColor=#ddeeff><input type=text name=CadOn2 size=20 maxlength=9 value="<%voip_tone_get("CadOn2");%>"> <font size=1>(msec)</font></td>
	</tr>
   <tr>
		<td  bgColor=#aaddff>CadOff2</td>
    	<td bgColor=#ddeeff><input type=text name=CadOff2 size=20 maxlength=9 value="<%voip_tone_get("CadOff2");%>"> <font size=1>(msec)</font></td>
	</tr>
   <tr>
		<td  bgColor=#aaddff>CadOn3</td>
    	<td bgColor=#ddeeff><input type=text name=CadOn3 size=20 maxlength=9 value="<%voip_tone_get("CadOn3");%>"> <font size=1>(msec)</font></td>
	</tr>

   <tr>
		<td  bgColor=#aaddff>CadOff3</td>
    	<td bgColor=#ddeeff><input type=text name=CadOff3 size=20 maxlength=9 value="<%voip_tone_get("CadOff3");%>"> <font size=1>(msec)</font></td>
	</tr>
	...
	<input type=text name=Freq1 size=20 maxlength=4 value="<%voip_tone_get("Freq1");%>"> <font size=1>(Hz)</font></td>
   	...
   	<tr>
    	<td bgColor=#aaddff rowspan=2>Freq2</td>
    	<td bgColor=#ddeeff>
	...
	<tr>
		<td bgColor=#ddeeff><font size=1>Freq2 is supported when SUCC/FOUR_FREQ/STEP_INC/TWO_STEP tone type</font>
		</td>	
	</tr>
	...
	<tr>
		<td bgColor=#ddeeff><font size=1>Freq3 is supported when FOUR_FREQ/STEP_INC/TWO_STEP tone type</font>
		</td>	
	</tr>


   	<tr>
    	<td bgColor=#aaddff>Gain0</td>
    	<td bgColor=#ddeeff>
