...
<table cellSpacing=1 cellPadding=2 border=0>
	...
	<tr>
		<td bgColor=#aaddff>Send Caller ID hidden</td>
		<td bgColor=#ddeeff><input type=checkbox name=caller_id_hidden <%voip_general_get("caller_id_hidden");%>>Enable</td>
	</tr>
	<tr>
		<td bgColor=#aaddff>Call Transfer</td>
		<td bgColor=#ddeeff><input type=checkbox name=Call_Transfer <%voip_general_get("Call_Transfer");%>>Enable</td>
	</tr>
	<tr>
		<td bgColor=#aaddff>3-Way Conference</td>
	<td bgColor=#ddeeff><input type=checkbox name=3PTY_Conference <%voip_general_get("3PTY_Conference");%>>Enable</td>
	</tr>
</table>
<p>
<b>Forward Mode</b>
...
-->	
  	<tr>
    	<td bgColor=#aaddff width=155>Enable Dialplan</td>
    	<td bgColor=#ddeeff width=170>
