...
MIBSTR(char,            uri,    				[URI_LEN],  PROXY_URI,			V_STRING, 	voipCfgProxy_t, 0, 0) //for tr104
/* register server */
...
MIBSTR(char,            RegistrarServer_addr,	[DNS_LEN],  PROXY_REGISTRARSERVER_ADDR,    		V_STRING, 	voipCfgProxy_t, 0, 0)
MIBDEF(unsigned short,  RegistrarServer_port,	NOREP, 		PROXY_REGISTRARSERVER_PORT,			V_WORD,   	voipCfgProxy_t, 0, 0)
...
MIBDEF(unsigned short,  media_port_max,		NOREP,		MEDIA_PORT_MAX,		V_WORD,		voipCfgPortParam_t, 0, 0)
...
MIBDEF(unsigned long,   fxsport_flag,     NOREP, 		FXSPORT_FLAG,     V_DWORD,    	voipCfgPortParam_t, 0, 0)
...
//MIBDEF(unsigned long,	specialflag,		NOREP,		SPECIAL_FLAG,		V_DWORD,	voipCfgParam_t, 0, 0)

//dial number length
MIBDEF(unsigned short,  max_dial_num,			NOREP, 		MAX_DIAL_NUM,V_WORD,   		voipCfgParam_t, 0, 0)
MIBDEF(unsigned short,  min_dial_num,			NOREP, 		MIN_DIAL_NUM,V_WORD,   		voipCfgParam_t, 0, 0)
MIBDEF(unsigned short,  MINI_SessionExpire,		NOREP, 		MINI_SESSION_EXPIRE,V_WORD,	voipCfgParam_t, 0, 0)
