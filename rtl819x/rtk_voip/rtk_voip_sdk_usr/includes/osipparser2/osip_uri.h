 ...
 */
struct osip_uri {
	//Valgrind, ToDo, Alex, modify 'char *scheme' to 'char scheme[xx]'
    char scheme[schemeSize];            /**< Uri Scheme (sip or sips) */
    char username[usernameSize];        /**< Username */
    char password[passwordSize];        /**< Password */
    char host[hostSize];                /**< Domain */
    unsigned int port;                  /**< Port number */
    osip_list_t url_params;             /**< Uri parameters */
    osip_list_t url_headers;            /**< Uri headers */
    char string[stringSize];            /**< Space for other url schemes. (http, mailto...) */
};
