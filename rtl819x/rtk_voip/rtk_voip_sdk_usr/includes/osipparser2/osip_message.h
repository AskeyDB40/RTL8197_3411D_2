...
//[SD6, ericchung, rcm integration , origin phonenumber length
#define RCM_SIP_PHONENUMBER_MAX_LENGTH 40
 ...
 */
    ...
    osip_list_t www_authenticates;            /**< WWW-Authenticate headers */
		...
		/* 20110628, bohungwu@SD6, add osip_replace support */
		...
		//[SD6, ericchung, rcm integration , origin phonenumber length
		char orig_number[RCM_SIP_PHONENUMBER_MAX_LENGTH];		  /** origin phone number */
		/* support outbound proxy */
		int outbound_port; //eric note for outbound port.
		char outbound_proxy[hostSize]; //eric note for otubound proxy.
	};
