 ...
 */
  typedef osip_from_t osip_route_t;
	typedef osip_content_length_t osip_service_route_t;
#ifdef __cplusplus
extern "C"
{
#endif
...
int osip_service_route_clone(const osip_service_route_t * service_route, osip_service_route_t ** dest);
  int osip_service_routes_init(osip_list_t **routes);
