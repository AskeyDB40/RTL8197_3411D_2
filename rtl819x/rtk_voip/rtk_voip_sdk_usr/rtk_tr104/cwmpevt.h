...
typedef struct voiceProfileLineStatusObj{
	...
	unsigned int ReceivePacketLossRate;			/*InternetGatewayDevice.Services.VoiceService.{i}.VoiceProfile.{i}.Line.{i}.Stats.ReceivePacketLossRate*/
	unsigned int FarEndPacketLossRate;				/*InternetGatewayDevice.Services.VoiceService.{i}.VoiceProfile.{i}.Line.{i}.Stats.FarEndPacketLossRate*/
	unsigned int ReceiveInterarrivalJitter;			/*InternetGatewayDevice.Services.VoiceService.{i}.VoiceProfile.{i}.Line.{i}.Stats.ReceiveInterarrivalJitter*/
	unsigned int FarEndInterarrivalJitter;			/*InternetGatewayDevice.Services.VoiceService.{i}.VoiceProfile.{i}.Line.{i}.Stats.FarEndInterarrivalJitter*/
	unsigned int RoundTripDelay;					/*InternetGatewayDevice.Services.VoiceService.{i}.VoiceProfile.{i}.Line.{i}.Stats.RoundTripDelay*/
	unsigned int AverageReceiveInterarrivalJitter;	/*InternetGatewayDevice.Services.VoiceService.{i}.VoiceProfile.{i}.Line.{i}.Stats.AverageReceiveInterarrivalJitter*/
	unsigned int AverageFarEndInterarrivalJitter;		/*InternetGatewayDevice.Services.VoiceService.{i}.VoiceProfile.{i}.Line.{i}.Stats.AverageFarEndInterarrivalJitter*/
	unsigned int AverageRoundTripDelay;			/*InternetGatewayDevice.Services.VoiceService.{i}.VoiceProfile.{i}.Line.{i}.Stats.AverageRoundTripDelay*/
...
//Support 2fxs port
	int TestStatus[2];//VoiceService.{i}.PhyInterface.{i}.Tests.TestState , 0:none, 1:Requested  , 2:Complete
	int TestSelector[2];////VoiceService.{i}.PhyInterface.{i}.Tests.TestSelector  0: PhoneConnectivityTest,1: X_SimulateTest
	int PhoneConnectivity[2]; //VoiceService.{i}.PhyInterface.{i}.Tests.TestState , 0:non
