...
#define MAX_PHYINTERFACE_COUNT              CON_CH_NUM
#define MAX_POORQUALITYLIST_COUNT			1		//FIXME
#define PROFILE_MAX_SESSION					2		
#define PROFILE_MAX_CALL_LOG				10		//TEMP
...
#define MIN_INCOMING_RTP_PORT 				0 		/* Base of port range to be used for incoming RTP streams */
#define MAX_INCOMING_RTP_PORT 				65535	/* Top of port range to be used for incoming RTP streams */
#define  PREFIX_INFO_MAX_ENTRIES 1
/* ASSERT */	//redefine
