...
typedef struct id2str_line_callstatus_s {
	line_callstatus_t idLineCallStatus;
	const char *pszLineCallStatus;
} id2str_line_callstatus_t;
...
static id2str_line_callstatus_t id2str_line_callstatus[] = {
	{ IDLE,				"Idle" },
	{ CALLING,			"Calling" },
	{ RINGING,			"Ringing" },
...
#define SIZE_OF_ID2STR_LINE_CALLSTATUS		( sizeof( id2str_line_callstatus ) / sizeof( id2str_line_callstatus[ 0 ] ) )
/*
 * ====================================================================
...
M_IMPLEMENT_STRDUP_AND_STR2ID_XXX( LINE_CALLSTATUS, LineCallStatus, line_callstatus)
