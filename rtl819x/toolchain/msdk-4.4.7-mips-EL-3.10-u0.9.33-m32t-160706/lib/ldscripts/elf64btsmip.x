...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("/tmp/builder-jenkins/msdk-4.4.7-2458/release/msdk-4.4.7/linux/uclibc/mips-linux-uclibc/lib64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
