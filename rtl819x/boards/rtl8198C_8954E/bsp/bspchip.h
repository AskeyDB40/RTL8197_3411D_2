...
#define BSP_GPIO_ABCD_IRQ               (BSP_IRQ_GIC_BASE+26)
#define BSP_GPIO_EFGH_IRQ               (BSP_IRQ_GIC_BASE+27)
...
#define BSP_SPI_IRQ		(BSP_IRQ_GIC_BASE+41)		
#define BSP_I2S_IRQ		(BSP_IRQ_GIC_BASE+36)
