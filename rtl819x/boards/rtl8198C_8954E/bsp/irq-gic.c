...
//	{ X, X,            X,           X,              0 },  //27
	...
	{ 0, GIC_CPU_INT0, GIC_POL_POS, GIC_TRIG_LEVEL, GIC_FLAG_TRANSPARENT },  //26  gpio ABCD
	
	{ 0, GIC_CPU_INT0, GIC_POL_POS, GIC_TRIG_LEVEL, GIC_FLAG_TRANSPARENT },  //27  gpio EFGH
	{ X, X,            X,           X,              0 },  //28
	{ X, X,            X,           X,              0 },  //29
	{ X, X,            X,           X,              0 },  //30
	...
	{ 0, GIC_CPU_INT0, GIC_POL_POS, GIC_TRIG_LEVEL, GIC_FLAG_TRANSPARENT  },  //36, iis
#else
	{ X, X,            X,           X,              0 },  //36
#endif
	{ X, X,            X,           X,              0 },  //37
