...
// default not enable tr069 in wsc
#ifdef TR069_SUPPORT
#undef TR069_SUPPORT
#endif
...
#ifdef TR069_SUPPORT
	unsigned char devname[MAX_DEVICE_NAME_LEN]; // 32
#endif
	int tx_size;
...
#ifdef TR069_SUPPORT
#ifndef __ECOS
#define PARAM_TEMP_FILE_tr069 ("/tmp/flash_param_wsc_for_tr069")
#define FLAG_ERRCODE			0x1
#define FLAG_EXTREG				0x2
#define FLAG_LOCK_DOWN			0x4
#define FLAG_ER_INCR  			0x10
#define FLAG_ER_DECR  			0x20
#define FLAG_ER_DECRALL  		0x40
#endif
...
#ifdef TR069_SUPPORT
	unsigned int ER_num;
	extRegInfoT extReg[MAX_EXTERNAL_REGISTRAR_NUM];
#endif
} CTX_T, *CTX_Tp;
...
#ifdef TR069_SUPPORT
extern int set_last_config_err(CTX_Tp pCtx, unsigned int errFlag);
extern int set_external_registrar_info(CTX_Tp pCtx, STA_CTX_Tp pSta, unsigned int flag);
extern int set_lock_down_stat(CTX_Tp pCtx, unsigned int inValue);
#endif

/*for support WPS-1.0 2.0, don't need rebuild code*/
#define WPS_VERSION2		(pCtx->WPS_VERSION==2)
#define WPS_VERSION1		(pCtx->WPS_VERSION==1)
#define WPS_CLIENT_MODE		(pCtx->is_ap==0)
