...
#define MAX_HOLD_SUPP_NUM	128   //MAX_SUPPLICANT*2
#define FAILED_SUPP_HOLD_TIME 60
#endif
...
#ifdef HOLD_AUTH_FAIL_SUPP_A_WHILE
typedef struct _Dot1x_AuthFailSupp
{
	unsigned char	addr[ETHER_ADDRLEN];
	u_long 			holdTime;
}Dot1x_AuthFailSupp;
...
#endif
#ifdef HOLD_AUTH_FAIL_SUPP_A_WHILE
	Dot1x_AuthFailSupp	AuthFailSupp[MAX_HOLD_SUPP_NUM];
#endif
} Dot1x_Authenticator;
