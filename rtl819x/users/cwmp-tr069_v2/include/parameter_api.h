...
/*star:20091207 START add for password type parameters*/
/*When ACS get some parameters' value, CPE should return empty string, these ones are treated as password type. Now 
we set these parameters' flag with CWMP_PASSWORD, the getvalue() function return the real string and in function 
cwmp_GetParameterValues() the value is changed to empty string*/

#define CWMP_PASSWORD  0x20
