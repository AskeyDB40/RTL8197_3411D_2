...
extern FILE *zfopen(const char *filename, const char *mode);
extern int zfread(void *ptr, size_t buf_size, size_t num_size, FILE *stream);
extern int zfclose(FILE *pf);
