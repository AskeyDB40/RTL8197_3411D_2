...
#ifdef _PRMT_TR143_
    {&tDevObjectInfo[eDownloadDiagnostics],	tDownloadDiagnosticsLeaf,NULL},
    {&tDevObjectInfo[eUploadDiagnostics],	tUploadDiagnosticsLeaf,	NULL},
    {&tDevObjectInfo[eUDPEchoConfig],	tUDPEchoConfigLeaf,	NULL},
#endif //_PRMT_TR143_
	{NULL,					NULL,			NULL}
};
