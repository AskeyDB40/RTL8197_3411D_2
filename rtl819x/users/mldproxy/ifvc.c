	...
	IfPt = IfVc;
	{
		...
		while ((fscanf( file,
				...
				printf( "addr:%08x:%08x:%08x:%08x\n",
					addr.sin6_addr.s6_addr32[0],addr.sin6_addr.s6_addr32[1],addr.sin6_addr.s6_addr32[2],addr.sin6_addr.s6_addr32[ 3]);
#endif
			...
			*/
			...
			if (IN6_IS_ADDR_LINKLOCAL(addr.sin6_addr.s6_addr32))
			{
