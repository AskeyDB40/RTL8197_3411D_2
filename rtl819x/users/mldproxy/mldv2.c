...
int mld_update_mr(struct in6_addr group, struct in6_addr src, int enable ,int ifindex)
{
	...
	printf("[%s]:[%d].\n",__FUNCTION__,__LINE__);
	printf( "srcaddr:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x\n",
	src.s6_addr[ 0],src.s6_addr[ 1],src.s6_addr[ 2],src.s6_addr[ 3],
	src.s6_addr[ 4],src.s6_addr[ 5],src.s6_addr[ 6],src.s6_addr[ 7],
	src.s6_addr[ 8],src.s6_addr[ 9],src.s6_addr[ 10],src.s6_addr[ 11],
	src.s6_addr[ 12],src.s6_addr[ 13],src.s6_addr[ 14],src.s6_addr[ 15],);
	
	printf( "grouppaddr:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x\n",
	group.s6_addr[ 0],group.s6_addr[ 1],group.s6_addr[ 2],group.s6_addr[ 3],
	group.s6_addr[ 4],group.s6_addr[ 5],group.s6_addr[ 6],group.s6_addr[ 7],
	group.s6_addr[ 8],group.s6_addr[ 9],group.s6_addr[ 10],group.s6_addr[ 11],
	group.s6_addr[ 12],group.s6_addr[ 13],group.s6_addr[ 14],group.s6_addr[ 15]);
...
}*/
{
	...
	group.s6_addr[ 4],group.s6_addr[ 5],group.s6_addr[ 6],group.s6_addr[ 7],
	group.s6_addr[ 8],group.s6_addr[ 9],group.s6_addr[ 10],group.s6_addr[ 11],
	group.s6_addr[ 12],group.s6_addr[ 13],group.s6_addr[ 14],group.s6_addr[ 16]);
	if (mymcp->if_count==1)
	{
...
int mldv2_query( struct mcft_entry *entry, int srcnum, struct in6_addr *srcfilter )
{
    ...
    mldv2_q->mld2q_nsrcs     = htons((unsigned short)srcnum);
    totalsize	      = sizeof(struct mld2_query)+srcnum*sizeof(struct in6_addr);//sizeof(__u32)ÊÇ·ñÐèÒªÐÞ¸Äå?
	...
	switch (mldh->mld_icmp6_hdr.icmp6_type) {
		...
		case ICMPV6_MGM_REPORT:

			{
				...
				group = &mldh->mld_addr;
				printf( "srcaddr:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x\n",
				src->sin6_addr.s6_addr[ 0],src->sin6_addr.s6_addr[ 1],src->sin6_addr.s6_addr[ 2],src->sin6_addr.s6_addr[ 3],
				src->sin6_addr.s6_addr[ 4],src->sin6_addr.s6_addr[ 5],src->sin6_addr.s6_addr[ 6],src->sin6_addr.s6_addr[ 7],
				src->sin6_addr.s6_addr[ 8],src->sin6_addr.s6_addr[ 9],src->sin6_addr.s6_addr[ 10],src->sin6_addr.s6_addr[ 11],
				src->sin6_addr.s6_addr[ 12],src->sin6_addr.s6_addr[ 13],src->sin6_addr.s6_addr[ 14],src->sin6_addr.s6_addr[ 15]);
				printf( "dstaddr:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x\n",
				dst->s6_addr[ 0],dst->s6_addr[ 1],dst->s6_addr[ 2],dst->s6_addr[ 3],
				dst->s6_addr[ 4],dst->s6_addr[ 5],dst->s6_addr[ 6],dst->s6_addr[ 7],
				dst->s6_addr[ 8],dst->s6_addr[ 9],dst->s6_addr[ 10],dst->s6_addr[ 11],
				dst->s6_addr[ 12],dst->s6_addr[ 13],dst->s6_addr[ 14],dst->s6_addr[ 15]);
