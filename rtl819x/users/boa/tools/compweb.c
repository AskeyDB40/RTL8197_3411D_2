...
int main(int argc, char* argv[])
{
	...
	if(!strcmp(platform, "vpn"))
		...
		tag = "w6bv";
#elif defined(CONFIG_RTL_8197F) || defined(CONFIG_RTL_8198C) || defined(CONFIG_RTL_8196C) || defined(CONFIG_RTL_8198) || defined(CONFIG_RTL_819XD) || defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8198B)
                tag = "w6cv";
#else		
		tag = "webv";
#endif
