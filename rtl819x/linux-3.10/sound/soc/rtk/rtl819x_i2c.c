...
//----------------------- ALC5621 codec ----------------------------------------------
#define I2C_RATING_FACTOR	100	//Adjust I2C read and write rating.
//There is an I2C protocal.
...
#elif defined(CONFIG_SND_RTL819XD_SOC_ALC5628)
...
#undef I2C_RATING_FACTOR
    ...
    #define I2C_RATING_FACTOR	10
 #elif defined(CONFIG_SND_RTL819XD_SOC_ALC5633Q)
    #define I2C_RATING_FACTOR	10
 #elif defined(CONFIG_SND_RTL819XD_SOC_ALC5642)
    #define I2C_RATING_FACTOR	10
 #elif defined(CONFIG_SND_RTL819XD_SOC_ALC5621)
    #define I2C_RATING_FACTOR	10
 #else
    #define I2C_RATING_FACTOR	1
 #endif
...
#if !defined(CONFIG_SND_RTL819XD_SOC_ALC5628) && !defined(CONFIG_SND_RTL819XD_SOC_ALC5642) && !defined(CONFIG_SND_RTL819XD_SOC_ALC5633Q)
