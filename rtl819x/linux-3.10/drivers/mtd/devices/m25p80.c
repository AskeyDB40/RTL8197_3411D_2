...
struct flash_device device = {
	{&info_mxic, &info_esmt, &info_winbond, &info_spansion,
	 &info_gigadevice, &info_eon, &info_micron}
};
...
static int get_flash_device(struct m25p *flash, u32 jedec_id)
{
	...
	pr_info("\n>>>>>No Flash Vendor support (0x%x)<<<<<\n\n",
	       jedec_id);
#if 1
	pr_err("use MXIC as flash vendor instead\n");
...
static int m25p80_erase(struct mtd_info *mtd, struct erase_info *instr)
{
	...
	if (len == flash->mtd.size) {
		 ...
		 * We may have set up to use "small sector erase",
...
#define INFO(_jedec_id, _ext_id, _sector_size, _n_sectors, \
		_flags, _normal_clk, _fastrd_clk, _ex_flags)	\
...
#define CAT25_INFO(_sector_size, _n_sectors, _page_size, \
	_addr_width, _flags, _normal_clk, _fastrd_clk, _ex_flags)	\
	((kernel_ulong_t)&(struct flash_info) {				\
		.sector_size = (_sector_size),				\
		.n_sectors = (_n_sectors),				\
...
static const struct spi_device_id m25p_ids[] = {
	...
	{"at25fs010",
	 INFO(0x1f6601, 0, 32 * 1024, 4, SECT_4K, 41000000, 41000000, 0x0)},
	{"at25fs040",
	 INFO(0x1f6604, 0, 64 * 1024, 8, SECT_4K, 41000000, 41000000, 0x0)},

	{"at25df041a",
	 INFO(0x1f4401, 0, 64 * 1024, 8, SECT_4K, 29000000, 41000000, 0x0)},
	{"at25df321a",
	 INFO(0x1f4701, 0, 64 * 1024, 64, SECT_4K, 41000000, 75000000, 0x0)},
	{"at25df641",
	 INFO(0x1f4800, 0, 64 * 1024, 128, SECT_4K, 41000000, 75000000, 0x0)},

	{"at26f004",
	 INFO(0x1f0400, 0, 64 * 1024, 8, SECT_4K, 18000000, 29000000, 0x0)},
	{"at26df081a",
	 INFO(0x1f4501, 0, 64 * 1024, 16, SECT_4K, 29000000, 41000000, 0x0)},
	{"at26df161a",
	 INFO(0x1f4601, 0, 64 * 1024, 32, SECT_4K, 29000000, 41000000, 0x0)},
	{"at26df321",
	 INFO(0x1f4700, 0, 64 * 1024, 64, SECT_4K, 29000000, 41000000, 0x0)},

	{"at45db081d",
	 INFO(0x1f2500, 0, 64 * 1024, 16, SECT_4K, 29000000, 41000000, 0x0)},

	/* EON -- en25xxx */
	{"en25f16",
	 INFO(0x1c3115, 0, 64 * 1024, 32, SECT_4K, 41000000, 75000000, 0x0)},
	{"en25f32",
	 INFO(0x1c3116, 0, 64 * 1024, 64, SECT_4K, 41000000, 75000000, 0x0)},
	{"en25p32",
	 INFO(0x1c2016, 0, 64 * 1024, 64, 0, 41000000, 75000000, 0x0)},
	{"en25q16",
	 INFO(0x1c3015, 0, 64 * 1024, 32, 0, 41000000, 75000000, 0x0)},
	{"en25q32b",
	 INFO(0x1c3016, 0, 64 * 1024, 64, 0, 41000000, 100000000, 0x0)},
	{"en25p64",
	 INFO(0x1c2017, 0, 64 * 1024, 128, 0, 41000000, 75000000, 0x0)},
	{"en25q64",
	 INFO(0x1c3017, 0, 64 * 1024, 128, SECT_4K, 41000000, 100000000, 0x0)},
	{"en25qh256",
	 INFO(0x1c7019, 0, 64 * 1024, 512, 0, 41000000, 75000000, 0x0)},

	/* ESMT */
	{"f25l08qa(2s)",
	 INFO(0x8c4014, 0, 64 * 1024, 16, SECT_4K, 29000000, 41000000, 0x0)},
	{"f25l16pa(2s)",
	 INFO(0x8c2115, 0, 64 * 1024, 32, SECT_4K, 41000000, 41000000, 0x0)},
	{"f25l16qa(2s)",
	 INFO(0x8c4015, 0, 64 * 1024, 32, SECT_4K, 41000000, 41000000, 0x0)},
	{"f25l32pa",
	 INFO(0x8c2016, 0, 64 * 1024, 64, SECT_4K, 29000000, 41000000, 0x0)},
	{"f25l32qa",
	 INFO(0x8c4016, 0, 64 * 1024, 64, SECT_4K, 29000000, 41000000, 0x0)},
	{"f25l32qa(2s)",
	 INFO(0x8c4116, 0, 64 * 1024, 64, SECT_4K, 41000000, 41000000, 0x0)},
	{"f25l64qa",
	 INFO(0x8c4117, 0, 64 * 1024, 128, SECT_4K, 41000000, 41000000,
	      FLASH_VERIFIED)},
	{"f25l128qa",
	 INFO(0x8c4118, 0, 64 * 1024, 256, SECT_4K, 41000000, 100000000, 0x0)},

	/* Everspin */
	{"mr25h256",
	 CAT25_INFO(32 * 1024, 1, 256, 2, M25P_NO_ERASE | M25P_NO_FR, 29000000,
		    29000000, 0x0)},
	{"mr25h10",
	 CAT25_INFO(128 * 1024, 1, 256, 3, M25P_NO_ERASE | M25P_NO_FR, 29000000,
		    29000000, 0x0)},

	/* GigaDevice */
	{"gd25q80",
	 INFO(0xc84014, 0, 64 * 1024, 16, SECT_4K, 41000000, 100000000, 0x0)},
	{"gd25q16",
	 INFO(0xc84015, 0, 64 * 1024, 32, SECT_4K, 41000000, 100000000, 0x0)},
	{"gd25q32",
	 INFO(0xc84016, 0, 64 * 1024, 64, SECT_4K, 75000000, 100000000, 0x0)},
	{"gd25q64",
	 INFO(0xc84017, 0, 64 * 1024, 128, SECT_4K, 41000000, 41000000,
	      FLASH_VERIFIED)},
	{"gd25q128",
	 INFO(0xc84018, 0, 64 * 1024, 256, SECT_4K, 75000000, 100000000, 0x0)},

	/* Intel/Numonyx -- xxxs33b */
	{"160s33b",
	 INFO(0x898911, 0, 64 * 1024, 32, 0, 29000000, 41000000, 0x0)},
	{"320s33b",
	 INFO(0x898912, 0, 64 * 1024, 64, 0, 29000000, 41000000, 0x0)},
	{"640s33b",
	 INFO(0x898913, 0, 64 * 1024, 128, 0, 29000000, 41000000, 0x0)},

	/* Macronix */
	{"mx25l2005a",
	 INFO(0xc22012, 0, 64 * 1024, 4, SECT_4K, 29000000, 41000000, 0x0)},
	{"mx25l4005a",
	 INFO(0xc22013, 0, 64 * 1024, 8, SECT_4K, 29000000, 75000000, 0x0)},
	{"mx25l8005",
	 INFO(0xc22014, 0, 64 * 1024, 16, 0, 29000000, 41000000, 0x0)},
	{"mx25l1606e",
	 INFO(0xc22015, 0, 64 * 1024, 32, SECT_4K, 29000000, 75000000, 0x0)},
	{"mx25l1633e",
	 INFO(0xc22415, 0, 64 * 1024, 32, SECT_4K, 29000000, 100000000, 0x0)},
	{"mx25l1635e",
	 INFO(0xc22515, 0, 64 * 1024, 32, SECT_4K, 41000000, 100000000, 0x0)},
	{"mx25l3205d",
	 INFO(0xc22016, 0, 64 * 1024, 64, 0, 29000000, 41000000,
	      FLASH_VERIFIED)},
	{"mx25l3235d",
	 INFO(0xc25e16, 0, 64 * 1024, 64, SECT_4K, 29000000, 100000000, 0x0)},
	{"mx25l3255e",
	 INFO(0xc29e16, 0, 64 * 1024, 64, SECT_4K, 41000000, 100000000, 0x0)},
	{"mx25l6405d",
	 INFO(0xc22017, 0, 64 * 1024, 128, 0, 29000000, 41000000,
	      FLASH_VERIFIED)},
	{"mx25l12805d",
	 INFO(0xc22018, 0, 64 * 1024, 256, 0, 29000000, 41000000,
	      FLASH_VERIFIED)},
	{"mx25l12855e",
	 INFO(0xc22618, 0, 64 * 1024, 256, 0, 41000000, 41000000, 0x0)},
	{"mx25l25635e",
	 INFO(0xc22019, 0, 64 * 1024, 512, 0, 41000000, 75000000, 0x0)},
	{"mx25l25655e",
	 INFO(0xc22619, 0, 64 * 1024, 512, 0, 41000000, 41000000, 0x0)},
	{"mx25l51245g",
	 INFO(0xc2201a, 0, 64 * 1024, 1024, 0, 41000000, 100000000,
	      FLASH_VERIFIED)},
	{"mx66l1g45g",
	 INFO(0xc2201b, 0, 64 * 1024, 2048, 0, 41000000, 100000000, 0x0)},

	/* Micron */
	{"n25q064",
	 INFO(0x20ba17, 0, 64 * 1024, 128, 0, 41000000, 100000000,
	      FLASH_VERIFIED)},
	{"n25q128a11",
	 INFO(0x20bb18, 0, 64 * 1024, 256, 0, 41000000, 100000000, 0x0)},
	{"n25q128a13",
	 INFO(0x20ba18, 0, 64 * 1024, 256, 0, 41000000, 100000000,
	      FLASH_VERIFIED)},
	{"n25q256a",
	 INFO(0x20ba19, 0, 64 * 1024, 512, SECT_4K, 41000000, 100000000, 0x0)},
	{"n25q512a",
	 INFO(0x20bb20, 0, 64 * 1024, 1024, SECT_4K, 41000000, 100000000, 0x0)},

	/* PMC */
	{"pm25lv512",
	 INFO(0, 0, 32 * 1024, 2, SECT_4K_PMC, 18000000, 18000000, 0x0)},
	{"pm25lv010",
	 INFO(0, 0, 32 * 1024, 4, SECT_4K_PMC, 18000000, 18000000, 0x0)},
	{"pm25lq032",
	 INFO(0x7f9d46, 0, 64 * 1024, 64, SECT_4K, 29000000, 100000000, 0x0)},
	...
	{"s25fl256s0",
	 INFO(0x010219, 0x4d00, 256 * 1024, 128, 0, 41000000, 100000000, 0x0)},
	{"s25fl256s1",
	 INFO(0x010219, 0x4d01, 64 * 1024, 512, 0, 41000000, 100000000, 0x0)},
	{"s25fl512s",
	 INFO(0x010220, 0x4d00, 256 * 1024, 256, 0, 41000000, 100000000,
	      FLASH_VERIFIED)},
	{"s70fl01gs",
	 INFO(0x010221, 0x4d00, 256 * 1024, 256, 0, 41000000, 100000000, 0x0)},
	{"s25sl12800", INFO(0x012018, 0x0300, 256 * 1024, 64, 0, 0, 0, 0x0)},
	{"s25sl12801", INFO(0x012018, 0x0301, 64 * 1024, 256, 0, 0, 0, 0x0)},
	{"s25fl129p0",
	 INFO(0x012018, 0x4d00, 256 * 1024, 64, 0, 29000000, 100000000, 0x0)},
	{"s25fl129p1",
	 INFO(0x012018, 0x4d01, 64 * 1024, 256, 0, 29000000, 100000000, 0x0)},
...
#if 0
	{ "s25fl016k",
	 INFO(0xef4015, 0, 64 * 1024, 32, SECT_4K, 11000000, 11000000, 0x0) },
	{ "s25fl064k",
	 INFO(0xef4017, 0, 64 * 1024, 128, SECT_4K,
	 33000000, 80000000, FLASH_VERIFIED) },
#endif

	/* SST -- large erase sizes are "overlays", "sectors" are 4K */
	{"sst25vf040b",
	 INFO(0xbf258d, 0, 64 * 1024, 8, SECT_4K | SST_WRITE, 18000000,
	      41000000, 0x0)},
	{"sst25vf080b",
	 INFO(0xbf258e, 0, 64 * 1024, 16, SECT_4K | SST_WRITE, 18000000,
	      41000000, 0x0)},
	{"sst25vf016b",
	 INFO(0xbf2541, 0, 64 * 1024, 32, SECT_4K | SST_WRITE, 18000000,
	      41000000, 0x0)},
	{"sst25vf032b",
	 INFO(0xbf254a, 0, 64 * 1024, 64, SECT_4K | SST_WRITE, 18000000,
	      41000000, 0x0)},
	{"sst25vf064c",
	 INFO(0xbf254b, 0, 64 * 1024, 128, SECT_4K, 29000000, 41000000, 0x0)},
	{"sst25wf512",
	 INFO(0xbf2501, 0, 64 * 1024, 1, SECT_4K | SST_WRITE, 18000000,
	      29000000, 0x0)},
	{"sst25wf010",
	 INFO(0xbf2502, 0, 64 * 1024, 2, SECT_4K | SST_WRITE, 18000000,
	      29000000, 0x0)},
	{"sst25wf020",
	 INFO(0xbf2503, 0, 64 * 1024, 4, SECT_4K | SST_WRITE, 18000000,
	      29000000, 0x0)},
	{"sst25wf040",
	 INFO(0xbf2504, 0, 64 * 1024, 8, SECT_4K | SST_WRITE, 18000000,
	      29000000, 0x0)},
	...
	{"m25p80",
	 INFO(0x202014, 0, 64 * 1024, 16, 0, 18000000, 18000000, 0x0)},
	{"m25p16",
	 INFO(0x202015, 0, 64 * 1024, 32, 0, 18000000, 41000000, 0x0)},
	{"m25p32",
	 INFO(0x202016, 0, 64 * 1024, 64, 0, 18000000, 41000000, 0x0)},
	{"m25p64",
	 INFO(0x202017, 0, 64 * 1024, 128, 0, 18000000, 41000000, 0x0)},
	{"m25p128",
	 INFO(0x202018, 0, 256 * 1024, 64, 0, 18000000, 41000000, 0x0)},
	{"n25q032",
	 INFO(0x20ba16, 0, 64 * 1024, 64, 0, 41000000, 100000000, 0x0)},

	{"m25p05-nonjedec",
	 INFO(0, 0, 32 * 1024, 2, 0, 18000000, 18000000, 0x0)},
	{"m25p10-nonjedec",
	 INFO(0, 0, 32 * 1024, 4, 0, 18000000, 18000000, 0x0)},
	{"m25p20-nonjedec",
	 INFO(0, 0, 64 * 1024, 4, 0, 18000000, 18000000, 0x0)},
	{"m25p40-nonjedec",
	 INFO(0, 0, 64 * 1024, 8, 0, 18000000, 18000000, 0x0)},
	{"m25p80-nonjedec",
	 INFO(0, 0, 64 * 1024, 16, 0, 18000000, 18000000, 0x0)},
	{"m25p16-nonjedec",
	 INFO(0, 0, 64 * 1024, 32, 0, 18000000, 41000000, 0x0)},
	{"m25p32-nonjedec",
	 INFO(0, 0, 64 * 1024, 64, 0, 18000000, 41000000, 0x0)},
	{"m25p64-nonjedec",
	 INFO(0, 0, 64 * 1024, 128, 0, 18000000, 41000000, 0x0)},
	{"m25p128-nonjedec",
	 INFO(0, 0, 256 * 1024, 64, 0, 18000000, 41000000, 0x0)},

	{"m45pe10",
	 INFO(0x204011, 0, 64 * 1024, 2, 0, 29000000, 41000000, 0x0)},
	{"m45pe80",
	 INFO(0x204014, 0, 64 * 1024, 16, 0, 29000000, 41000000, 0x0)},
	{"m45pe16",
	 INFO(0x204015, 0, 64 * 1024, 32, 0, 29000000, 41000000, 0x0)},

	{"m25pe20",
	 INFO(0x208012, 0, 64 * 1024, 4, 0, 29000000, 41000000, 0x0)},
	{"m25pe80",
	 INFO(0x208014, 0, 64 * 1024, 16, 0, 18000000, 41000000, 0x0)},
	{"m25pe16",
	 INFO(0x208015, 0, 64 * 1024, 32, SECT_4K, 29000000, 41000000, 0x0)},

	{"m25px16",
	 INFO(0x207115, 0, 64 * 1024, 32, SECT_4K, 29000000, 75000000, 0x0)},
	{"m25px32",
	 INFO(0x207116, 0, 64 * 1024, 64, SECT_4K, 29000000, 75000000, 0x0)},
	{"m25px32-s0",
	 INFO(0x207316, 0, 64 * 1024, 64, SECT_4K, 29000000, 75000000, 0x0)},
	{"m25px32-s1",
	 INFO(0x206316, 0, 64 * 1024, 64, SECT_4K, 29000000, 75000000, 0x0)},
	{"m25px64",
	 INFO(0x207117, 0, 64 * 1024, 128, 0, 29000000, 75000000, 0x0)},

	/* Winbond -- w25x "blocks" are 64K, "sectors" are 4KiB */
	{"w25x10",
	 INFO(0xef3011, 0, 64 * 1024, 2, SECT_4K, 18000000, 29000000, 0x0)},
	{"w25x20",
	 INFO(0xef3012, 0, 64 * 1024, 4, SECT_4K, 18000000, 29000000, 0x0)},
	{"w25x40",
	 INFO(0xef3013, 0, 64 * 1024, 8, SECT_4K, 18000000, 29000000, 0x0)},
	{"w25x80",
	 INFO(0xef3014, 0, 64 * 1024, 16, SECT_4K, 18000000, 29000000, 0x0)},
	{"w25x16",
	 INFO(0xef3015, 0, 64 * 1024, 32, SECT_4K, 29000000, 41000000, 0x0)},
	{"w25x32",
	 INFO(0xef3016, 0, 64 * 1024, 64, SECT_4K, 29000000, 41000000, 0x0)},
	{"w25q16",
	 INFO(0xef4015, 0, 64 * 1024, 32, SECT_4K, 41000000, 75000000, 0x0)},
	{"w25q32",
	 INFO(0xef4016, 0, 64 * 1024, 64, SECT_4K, 41000000, 75000000, 0x0)},
	{"w25q32dw",
	 INFO(0xef6016, 0, 64 * 1024, 64, SECT_4K, 41000000, 100000000, 0x0)},
	{"w25x64",
	 INFO(0xef3017, 0, 64 * 1024, 128, SECT_4K, 29000000, 41000000, 0x0)},
	{"w25q64",
	 INFO(0xef4017, 0, 64 * 1024, 128, SECT_4K, 29000000, 41000000,
	      FLASH_VERIFIED)},
	{"w25q128",
	 INFO(0xef4018, 0, 64 * 1024, 256, SECT_4K, 29000000, 41000000,
	      FLASH_VERIFIED)},
	{"w25q80",
	 INFO(0xef5014, 0, 64 * 1024, 16, SECT_4K, 41000000, 75000000, 0x0)},
	{"w25q80bl",
	 INFO(0xef4014, 0, 64 * 1024, 16, SECT_4K, 18000000, 41000000, 0x0)},
	{"w25q256",
	 INFO(0xef4019, 0, 64 * 1024, 512, SECT_4K, 41000000, 41000000,
	      USE_4B_READ | FLASH_VERIFIED)},

	/* Catalyst / On Semiconductor -- non-JEDEC */
	{"cat25c11",
	 CAT25_INFO(16, 8, 16, 1, M25P_NO_ERASE | M25P_NO_FR, 1000000, 1000000,
		    0x0)},
	{"cat25c03",
	 CAT25_INFO(32, 8, 16, 2, M25P_NO_ERASE | M25P_NO_FR, 1000000, 1000000,
		    0x0)},
	{"cat25c09",
	 CAT25_INFO(128, 8, 32, 2, M25P_NO_ERASE | M25P_NO_FR, 1000000, 1000000,
		    0x0)},
	{"cat25c17",
	 CAT25_INFO(256, 8, 32, 2, M25P_NO_ERASE | M25P_NO_FR, 1000000, 1000000,
		    0x0)},
	{"cat25128",
	 CAT25_INFO(2048, 8, 64, 2, M25P_NO_ERASE | M25P_NO_FR, 4000000,
		    4000000, 0x0)},
...
static const struct spi_device_id *jedec_probe(struct spi_device *spi)
{
	...
	pr_info("use JEDEC id 0xffffff (unknown) instead\n");
...
static int m25p_probe(struct spi_device *spi)
{
	...
	/* If this flash hasn't been verified by ourself,
	 * then set the transfer clock a safe value */
#if 0
	...
	if (flash->mtd.numeraseregions)
		for (i = 0; i < flash->mtd.numeraseregions; i++)
			...
			pr_debug(".erasesize = 0x%.8x (%uKiB), ",
				 flash->mtd.eraseregions[i].erasesize,
				 flash->mtd.eraseregions[i].erasesize / 1024);
			pr_debug(".numblocks = %d }\n",
