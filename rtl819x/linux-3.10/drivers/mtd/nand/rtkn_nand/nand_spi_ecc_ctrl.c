...
void
ecc_encode_bch_6t(void *dma_addr, void *p_eccbuf, unsigned int pageaddr,unsigned int chunk_size
)
{
  ...
  if(pageaddr < boot_end_page)
  	...
  	bch6_sector_per_chunk = chunk_size/512;
...
int
ecc_decode_bch_6t(void *dma_addr, void *p_eccbuf, unsigned int pageaddr,unsigned int chunk_size
)
/*  Return value:
  *  -1: ECC decode fail
