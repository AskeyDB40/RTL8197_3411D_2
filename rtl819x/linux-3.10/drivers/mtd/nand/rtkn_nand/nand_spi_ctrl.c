...
SECTION_NAND_SPI void 
dma_write_data(void *dma_addr, u32_t dma_len, u32_t blk_pge_addr, cmd_info_t *snf_cmd_info,u32_t chunk_oob_size)
/*
  * Write More or Less than One Chunk (More or less than 2112-Byte)
  * Start from the initial cache register (CA=0x0000)
  */
{
    ...
    while(dma_len > 0){
		...
		max_byte_per_dma = 	chunk_oob_size;
...
#else
SECTION_NAND_SPI void 
dma_read_data(void *dma_addr, u32_t dma_len, u32_t blk_pge_addr, cmd_info_t *snf_cmd_info,u32_t chunk_oob_size)
/*
  * Read More or Less than One Chunk (More or less than 2112-Byte)
  * Start from the initial cache register (CA=0x0000)
  */
