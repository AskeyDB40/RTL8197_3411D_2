...
u32 otg_show_reg=0; //wei add
#if 1 //wei add 
static __inline__ void show_reg_name(unsigned int addr)
{
...
struct AddrName AddrNameTable[]=
{
	...
	"GCTL",		OTG_BASE+0x00,
	"GINT",		OTG_BASE+0x04,
	"GAHBCFG",		OTG_BASE+0x08,
	"GUSBCFG",		OTG_BASE+0x0c,
	"GRSTCTL",		OTG_BASE+0x10,
	"GINTSTS",		OTG_BASE+0x14,	
	"GINTMSK",		OTG_BASE+0x18,	
	
	"DCFG",		OTG_BASE+0x800,	
	"DCTL",		OTG_BASE+0x804,		
	"DSTS",		OTG_BASE+0x808,	

	"DIEPMSK",		OTG_BASE+0x810,	
	"DOEPMSK",		OTG_BASE+0x814,	
	"DAINT",		OTG_BASE+0x818,	
	"DAINTMSK",		OTG_BASE+0x81c,	

	"DIEP_CTL_0",		OTG_BASE+0x900,	
	"DIEP_INT_0",		OTG_BASE+0x908,	
	"DIEP_TSIZ_0",		OTG_BASE+0x910,	
	"DIEP_DMA_0",		OTG_BASE+0x914,	
	"DTXDSTS_0",		OTG_BASE+0x918,		
	
	"DOEP_CTL_0",		OTG_BASE+0xb00,	
	"DOEP_INT_0",		OTG_BASE+0xb08,	
	"DOEP_TSIZ_0",		OTG_BASE+0xb10,	
	"DOEP_DMA_0",		OTG_BASE+0xb14,	
...
//	"",0
	...
	for(i=0; i<len; i++)
	{
		if( addr==AddrNameTable[i].addr )		
		{	printk("\t%s",AddrNameTable[i].name );
		}
	}
