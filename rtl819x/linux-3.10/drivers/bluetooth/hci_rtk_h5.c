...
{
#if defined(CONFIG_WLAN_HAL_8822BE)                                                                                             
    REG32(0xb800083C) = (REG32(0xb800083C) & ~(0x00000F00))|(0x00000600);//MMC pin mux to MMC_D5
    REG32(0xb8003508) |= (1<<30);//output pin
    REG32(0xb800350C) = REG32(0xb800350C) | (1<<30);//disable BT
    mdelay(2000);
    REG32(0xb800350C) = REG32(0xb800350C) & (0<<30);//enable BT
    mdelay(2000);
    REG32(0xb800083C) = REG32(0xb800083C) & (~(0x00000600));
#endif
